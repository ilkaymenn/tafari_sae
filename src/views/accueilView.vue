<template>
  <div class="text-center lg:flex lg:h-screen">
    <div
    ...
    <div
      class="grid justify-items-center border-b-2 border-t-2 border-noir bg-jaune p-14 text-noir"
    >
      <img
    ...
    <div
      class="grid justify-items-center border-t-2 border-noir bg-rouge p-14 text-blanc"
    >
      <img
        src="../../public/joey-thompson.jpg"
        alt="image de festival"
